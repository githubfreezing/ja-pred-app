...
import CompareActualAndForecast from "../pages/CompareActualAndForecastPage";
import PredComfirmPage from "../pages/PredComfirmPage";
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/compare-actual-and-forecast"
        element={
          <CompareActualAndForecast />
        }
      />
